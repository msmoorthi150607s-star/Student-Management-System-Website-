...
<%
    /*
     * HOW IT WORKS:
     * 1. Admin clicks "Update Staff" → AdminController → action="updateStaff" → forwards here
     * 2. Admin searches by staff_id → staff loaded into form
     * 3. Admin edits → action="updateStaffSubmit" → adminDAO.updateStaff()
     */
...
<title>Update Staff – Menaka's ICL</title>
...
<main>
  <div class="page-header">
    ...
    <h1 class="page-title">Update <em>Staff</em></h1>
    <p class="page-sub">Search by staff ID then edit the details</p>
  </div>
  <% if (message != null) { %>
    ...
    <form action="AdminController" method="post" autocomplete="off">
      ...
      <div class="search-row">
        <div class="search-group">
          ...
          <input type="number" name="staff_id" placeholder="e.g. 1" min="1" required>
        </div>
  ...
  <% if (staff != null) { %>
  <div class="form-card">
    <div class="section-title">Edit Staff Details</div>
    <form action="AdminController" method="post" autocomplete="off">
      <input type="hidden" name="action" value="updateStaffSubmit">
      <div class="form-grid">
        <div class="form-group">
          <label>Staff ID</label>
          <div class="readonly-field">#<%= staff.getStaffId() %></div>
        ...
        <div class="form-group">
          ...
          <select name="role" required>
            <option value="Teaching" <%= "Teaching".equals(staff.getRole()) ? "selected" : "" %>>Teaching</option>
            <option value="Clerical" <%= "Clerical".equals(staff.getRole()) ? "selected" : "" %>>Clerical</option>
          </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label>Age</label>
          <input type="number" name="age" value="<%= staff.getAge() %>" min="18" max="65">
        </div>
        <div class="form-group">
          <label>Salary (Rs)</label>
          <input type="number" name="salary" value="<%= staff.getSalary() %>" min="0" step="0.01">
        </div>
      </div>
      <div class="btn-row">
