...
<title>My Attendance – Menaka's ICL</title>
...
<style>
  *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
  ...
  header::after{content:'';position:absolute;bottom:0;left:0;right:0;height:1px;background:linear-gradient(to right,transparent,rgba(90,158,114,0.35),transparent);}
  ...
  .att-wrap{max-width:600px;animation:fadeUp 0.5s 0.1s ease both;}

  /* big attendance number card */
  .att-hero{background:var(--card);border:1px solid var(--border);border-radius:16px;padding:40px 32px;text-align:center;position:relative;overflow:hidden;margin-bottom:20px;}
  .att-hero::before{content:'';position:absolute;top:0;left:0;right:0;height:2px;background:linear-gradient(to right,transparent,var(--green),transparent);}
  .att-number{font-family:'Cormorant Garamond',serif;font-size:80px;font-weight:600;color:var(--green);line-height:1;margin-bottom:8px;}
  .att-label{font-size:12px;font-weight:500;letter-spacing:0.12em;text-transform:uppercase;color:var(--muted);}
  .att-sub{font-size:13px;font-weight:300;color:var(--muted);margin-top:8px;}
  ...
  .info-card::before{content:'';position:absolute;top:0;left:0;right:0;height:2px;background:linear-gradient(to right,var(--amber),transparent);}
  .section-title{font-size:11px;font-weight:500;letter-spacing:0.12em;text-transform:uppercase;color:var(--amber);display:flex;align-items:center;gap:10px;margin-bottom:16px;}
  .section-title::after{content:'';flex:1;height:0.5px;background:rgba(196,154,74,0.2);}
  ...
  @media(max-width:820px){header{padding:0 20px;}main{padding:28px 20px 40px;}footer{padding:14px 20px;}.att-number{font-size:60px;}}
</style>
</head>
<body>
<header>
...
<main>
  <div class="page-header">
    ...
    <h1 class="page-title">My <em>Attendance</em></h1>
    <p class="page-sub">Your attendance record as maintained by admin</p>
  </div>
  ...
  <div class="att-wrap">
    ...
    <!-- Big number -->
    <div class="att-hero">
      <div class="att-number"><%= staff.getAttendance() %></div>
      <div class="att-label">Total Days Present</div>
      <div class="att-sub">Recorded by admin — <%= staff.getStaffName() %></div>
    </div>
    ...
    <div class="info-card">
      ...
      <div class="info-row">
        <span class="info-key">Days Present</span>
        <span class="info-val" style="color:var(--green);font-weight:600;"><%= staff.getAttendance() %></span>
      </div>
      ...
      <div class="notice">
        ...
        Attendance is marked and controlled by the admin. If you notice any discrepancy, please contact the administration.
      </div>
    </div>
